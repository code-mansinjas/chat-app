...
const Signup = () => {
  ...
  const confirmPassword = useRef<string | null>(null);
  const gender = useRef<string | null>(null);
    ...
    <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
      <div className="w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0">
        ...
        <form onSubmit={(e) => handleSubmit(e)} className="flex flex-col gap-8">
          ...
          <label className="flex items-start gap-3 flex-col border p-3 input-bordered">
            <h3>Gender</h3>
